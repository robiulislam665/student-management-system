...
@section('title', 'Student Update Information')

	@section('content')
        <div class="card">
            <div class="card-header text-center"><h3>Student Update Information</h3></div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('student/update', $student->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $student->phone_number }}" required autocomplete="phone_number" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="regi_id" type="text" class="form-control @error('regi_id') is-invalid @enderror" name="regi_id" value="{{ $student->regi_id }}" required autocomplete="regi_id" autofocus>
					...
					<div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="class_id" class="form-control @error('class_id') is-invalid @enderror" name="class_id" required>
							  ...
							  <option value="{{ $class->id }}" {{ $student->class_id == $class->id ? 'selected' : '' }}>{{ $class->title }}</option>
							  @endforeach
							</select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                        	<textarea id="present_address" class="form-control @error('present_address') is-invalid @enderror" name="present_address"  required autocomplete="present_address" autofocus>{{ $student->present_address }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="permanent_address" class="form-control @error('permanent_address') is-invalid @enderror" name="permanent_address" required autocomplete="permanent_address" autofocus>{{ $student->permanent_address }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="home_number" type="text" class="form-control @error('home_number') is-invalid @enderror" name="home_number" value="{{ $student->home_number }}" required autocomplete="home_number" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="image" class="col-md-4 col-form-label text-md-right">Home Number</label>

                        <div class="col-md-6">
                            <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ url($student->image) }}" required autocomplete="image" autofocus>
                            <img src="{{ url('uploads/students/', $student->image) }}" height="60" width="60">
